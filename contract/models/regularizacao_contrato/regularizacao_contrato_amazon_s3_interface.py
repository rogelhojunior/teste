...
class RegularizacaoContratoAmazonS3Interface:
    """
    RegularizacaoContratoAmazonS3Interface - Provides methods to interact with Amazon S3.

    This class allows you to download and upload files to Amazon S3, using attributes from
    the RegularizacaoContrato model to connect with S3.

    Args:
        regularizacao_contrato (RegularizacaoContrato): An instance of the RegularizacaoContrato model.
    ...
    def __init__(self, regularizacao_contrato: RegularizacaoContrato):
        """
        Initializes the AnexoContratoAmazonS3Interface.

        Args:
            regularizacao_contrato (RegularizacaoContrato): An instance of the AnexoContrato model.
        """
        self.regularizacao_contrato = regularizacao_contrato
    ...
    def object_key(self) -> str:
        ...
        Returns:
            str: The object key.
        """
        return self.regularizacao_contrato.extract_object_key_from_url()
    ...
    def bucket_name(self) -> str:
        ...
        Returns:
            str: The bucket name.
        """
        return self.regularizacao_contrato.extract_bucket_name_from_url()
    ...
    def is_s3(self) -> bool:
        ...
        """
        return self.regularizacao_contrato.is_stored_on_s3
