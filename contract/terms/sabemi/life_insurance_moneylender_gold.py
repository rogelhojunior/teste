...
class SabemiLifeInsuranceMoneyLenderGoldTerm:
    def __init__(self):
        self.file_path = 'static/sabemi/termo_adesao_vida_prestamista_ouro.pdf'
    ...
    def fill_term(self, data, contract, plano):
        try:
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                nome_arquivo = 'termo-vida-ouro-prestamista-sabemi'
                nome_anexo = 'TERMO VIDA OURO PRESTAMISTA SABEMI'
        ...
        try:
            ...
            for attachment in attachments:
                ...
                if (
                    ...
                    and f'termo-vida-ouro-prestamista-sabemi-{cpf_slugify}-{issue_date_slugify}'
                    in attachment_name
