...
class SabemiLifeInsuranceSilverTerm:
    def __init__(self):
        self.file_path = 'static/sabemi/termo_adesao_vida_prata.pdf'
    ...
    def fill_term(self, data, contract, plano):
        try:
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                nome_arquivo = 'termo-vida-prata-sabemi'
                nome_anexo = 'TERMO VIDA PRATA SABEMI'
        ...
        try:
            ...
            for attachment in attachments:
                ...
                if (
                    ...
                    and f'termo-vida-prata-sabemi-{cpf_slugify}-{issue_date_slugify}'
                    in attachment_name
    ...
    def _fill_term_third_section(self, contract, plano, canvas_pdf):
    ...
    def _sign_term_first_section(
        ...
        city_coord = word_coordinates_in_pdf(
            pdf_path=self.file_path, word='Cidade', word_order=2
        )
        ...
        date_coord = word_coordinates_in_pdf(
            pdf_path=self.file_path, word='Data', word_order=1
        )
        ...
        full_name_coord = word_coordinates_in_pdf(
            pdf_path=self.file_path, word='Nome', word_order=3
        )
        ...
        cpf_coord = word_coordinates_in_pdf(
            pdf_path=self.file_path, word='CPF', word_order=2
        )
