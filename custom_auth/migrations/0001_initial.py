...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('corban_name', models.CharField(max_length=250, verbose_name='Nome')),
                ('is_active', models.BooleanField(default=False, verbose_name='Ativo?')),
            ],
            options={
                'verbose_name': 'Corban',
                'verbose_name_plural': 'Corban',
            },
        ),
        migrations.CreateModel(
            name='Produtos',
            fields=[
                ...
                ('cd_produto', models.CharField(blank=True, max_length=50, null=True, verbose_name='Código do produto')),
